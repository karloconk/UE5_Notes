...
bool ULookAtActorComponent::LookAtActor()
{
		...
		IgnoreActors))
	{
		...
		FRotator LookAtLocation = UKismetMathLibrary::FindLookAtRotation(Start, End);
		GetOwner()->SetActorRotation(LookAtLocation);
		return true;
	}
...
bool ULookAtActorComponent::CanSeeTarget() const
{
